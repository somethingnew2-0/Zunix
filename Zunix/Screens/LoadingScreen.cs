    ...
    class LoadingScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (loadingIsSlow)
            {
                ...
                loadAnimationTimer += elapsedTime.ElapsedGameTime;
        ...
        void BackgroundWorkerThread()
        {
            ...
            {
                float elapsedTime = GetGameTime(ref lastTime);

                DrawLoadAnimation(elapsedTime);
            }
        }
        ...
        /// </summary>
        float GetGameTime(ref long lastTime)
        {
            ...
            return new float(loadStartTime.TotalRealTime + elapsedTime, elapsedTime,
        ...
        /// </summary>
        void DrawLoadAnimation(float elapsedTime)
        {
