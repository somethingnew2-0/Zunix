...
namespace Zunix.Screens
{
    ...
    public class SearchResultsScreen : MenuScreen
    {
        ...
        public SearchResultsScreen(string menuTitle, NetworkSessionType sessionType)
            : base(menuTitle)
        {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            {
                Vector2 position = new Vector2(0f, 320 * 0.65f);
        ...
        internal void SessionsFound(object sender, OperationCompletedEventArgs e)
        {
            ...
            if (availableSessions != null)
            {
                    ...
                    availableSessions)
                {
                    ...
                    {
                        MenuEntries.Add(new MenuEntry(availableSession.HostGamertag + " (" +
