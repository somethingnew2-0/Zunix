...
namespace Zunix.ScreensManager
{
    ...
    class MessageBoxScreen : GameScreen
    {
        ...
        string message;
        Texture2D grakillntTexture;

        const string usageTextOk = "A Button = Ok";
        const string usageTextCancel = "B Button = Cancel";
        ...
        public override void LoadContent()
        {
            ...
            grakillntTexture = content.Load<Texture2D>(@"Textures\grakillnt");
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (this.includeUsageTextOk || this.includeUsageTextCancel)
            {
                ...
                spriteBatch.DrawString(font, usageTextOk, new Vector2(10, 280), color);
