...
namespace Zunix
{
    ...
    public static class ZunePad
    {
        ...
        /// </summary>
        /// <param name="elapsedTime">The current time snapshot</param>
        /// <returns>The new ZunePadState object.</returns>
        public static ZunePadState GetState(float elapsedTime)
        {
